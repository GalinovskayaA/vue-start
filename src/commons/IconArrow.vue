<template>
  <svg version="1.0" xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 1600.000000 933.000000" preserveAspectRatio="xMidYMid meet">
    <g transform="translate(0.000000,933.000000) scale(0.100000,-0.100000)" fill="currentColor" stroke="none">
      <path d="M3860 7315 c-35 -8 -101 -32 -145 -54 -239 -117 -378 -339 -378 -606
        ...
        -1383 1384 -1429 1412 -141 83 -341 117 -495 82z" class="svg-elem-1">
      </path>
    </g>
  </svg>
</template>
